...
const translations = {
  "zh-CN": {
    ...
    addAgent: "添加 Agent",
    addAgentHint: "先支持 Codex。Morrows 只记录目标机器上的凭据引用，不上传、不复制 auth.json。",
    agentProvider: "Provider",
    accountEmail: "账号邮箱",
    credentialKind: "凭据类型",
    credentialRef: "凭据引用",
    credentialRefHint: "例如 ~/.codex 或 ~/.codex-personal。该路径在 Agent 所属机器上解析，Morrows 不读取其中的登录 secret。",
    providerSecretStored: "保存 Provider Secret",
    codexCredentialLinked: "Codex 账号已绑定",
    codexCredentialLinkedHint: "仅保存账号身份和外部凭据引用；Provider 登录凭据仍由 Codex 自己管理。",
    yes: "是",
    no: "否",
  ...
  en: {
    ...
    addAgent: "Add agent",
    addAgentHint: "Codex is supported first. Morrows stores only a credential reference on the target machine; it never uploads or copies auth.json.",
    agentProvider: "Provider",
    accountEmail: "Account email",
    credentialKind: "Credential kind",
    credentialRef: "Credential reference",
    credentialRefHint: "For example ~/.codex or ~/.codex-personal. The path is resolved on the Agent machine; Morrows does not read provider login secrets from it.",
    providerSecretStored: "Provider secret stored",
    codexCredentialLinked: "Codex account linked",
    codexCredentialLinkedHint: "Only account identity and an external credential reference are stored; provider login credentials remain managed by Codex.",
    yes: "Yes",
    no: "No",
